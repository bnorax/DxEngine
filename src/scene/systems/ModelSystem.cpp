...
DirectX::XMMATRIX aiToXMMATRIX(const aiMatrix4x4& AssimpMatrix) //������ �� aiMatrix(assimp) -> ������� �� �������(XMfloat4x4)
{
	DirectX::XMMATRIX m;
...
DirectX::XMMATRIX aiToXMMATRIX(const aiMatrix3x3& AssimpMatrix) //������ �� aiMatrix(assimp) -> ������� �� �������(XMfloat3x3)
{
	DirectX::XMMATRIX m;
	m = DirectX::XMMatrixIdentity();
	m = DirectX::XMMatrixSet(
